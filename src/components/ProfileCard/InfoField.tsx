...
const InfoField: React.FC<InfoFieldProps> = ({ label, value }) => {
    return (
        <div className="flex flex-col justify-center mt-3 w-full max-w-[342px]">
            ...
            <div className="flex gap-10 justify-between items-center px-4 py-4 mt-1.5 w-full rounded-md border border-solid border-stone-300 min-h-[48px] text-stone-500">
