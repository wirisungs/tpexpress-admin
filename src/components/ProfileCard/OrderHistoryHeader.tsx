...
=======
  return (
    <div className="flex overflow-hidden flex-wrap gap-7 justify-between items-center self-center px-8 py-2.5 mt-6 w-full text-xs font-bold bg-white min-h-[42px] shadow-[0px_4px_5px_rgba(203,203,203,1)] text-stone-500 max-md:px-5">
      <HeaderItem label="Mã đơn" width="w-[70px]" />
      <HeaderItem label="Nhận/gửi" width="w-20" />
      <HeaderItem label="Người nhận/gửi" width="w-[114px]" />
      <HeaderItem label="Từ" width="w-[42px]" />
