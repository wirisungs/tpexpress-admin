...
const HeaderItem: React.FC<HeaderItemProps> = ({ label, width }) => (
  <div
    className={`flex overflow-hidden flex-col self-stretch my-auto ${width} whitespace-nowrap bg-white rounded-md`}
  >
    <div className="flex gap-3 items-center py-1.5 w-full bg-white">
      <div className="self-stretch my-auto">{label}</div>
      <Image
        loading="lazy"
        src="https://cdn.builder.io/api/v1/image/assets/TEMP/e4288d5ca337d3d5db543f745d8085868125fcedf74a85218600334bf90cfc20?placeholderIfAbsent=true&apiKey=15b59fc130e4444f91de6f123898acea"
        alt=""
